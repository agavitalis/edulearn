            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 rs-vertical-bottom mobile-mb-50">
                    	<a href="#">
							<img src="../appp/images/about/history.jpg" alt="History Image"/>
                    	</a>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                    	<div class="row">
                    		<div class="col-md-6 mobile-mb-30">
                    			<a href="#">
									<img src="../appp/images/about/mission1.jpg" alt="Mission Image"/>
		                    	</a> 
                    		</div>
                    		<div class="col-md-6">
		                    	<a href="#">
									<img src="../appp/images/about/mission2.jpg" alt="Mission Image"/>
		                    	</a>                 			
                    		</div>
                    	</div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 mobile-mb-50">
                        <div class="vision-img rs-animation-hover">
							<img src="../appp/images/about/vision.jpg" alt="img02"/>
        ...
        <div id="rs-team" class="rs-team sec-spacer">
            <div class="container">
				...
				<div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="false" data-autoplay-timeout="5000" data-smart-speed="1200" data-dots="true" data-nav="true" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="true" data-mobile-device-dots="true" data-ipad-device="2" data-ipad-device-nav="true" data-ipad-device-dots="true" data-md-device="3" data-md-device-nav="true" data-md-device-dots="true">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="../appp/images/team/1.jpg" alt="team Image" />
                    ...
                    <div class="team-item">
                        <div class="team-img">
                            <img src="../appp/images/team/2.jpg" alt="team Image" />
							<div class="normal-text">
                    ...
                    <div class="team-item">
                        <div class="team-img">
                            <img src="../appp/images/team/3.jpg" alt="team Image" />
							<div class="normal-text">
				...
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="branches-item">
							<img src="../appp/images/about/australia.png" alt="Australia Flag">
							<h3>
								<span>01</span>
								Australia
							</h3>
					...
					<div class="col-lg-3 col-md-6">
						<div class="branches-item">
							<img src="../appp/images/about/china.png" alt="China Flag">
							<h3>
								<span>02</span>
								China
							</h3>
					...
					<div class="col-lg-3 col-md-6">
						<div class="branches-item">
							<img src="../appp/images/about/india.png" alt="India Flag">
							<h3>
								<span>03</span>
								India
							</h3>
					...
					<div class="col-lg-3 col-md-6">
						<div class="branches-item">
							<img src="../appp/images/about/united-states.png" alt="United States Flag">
							<h3>
								<span>04</span>
								United States
							</h3>
            ...
            <div class="container">
				<div class="rs-carousel owl-carousel" data-loop="true" data-items="5" data-margin="80" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="2000" data-dots="false" data-nav="false" data-nav-speed="false" data-mobile-device="2" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="4" data-ipad-device-nav="false" data-ipad-device-dots="false" data-md-device="5" data-md-device-nav="false" data-md-device-dots="false">
                    <div class="partner-item">
                        <a href="#"><img src="../appp/../appp/images/partner/1.png" alt="Partner Image"></a>
                    </div>
                    <div class="partner-item">
                        <a href="#"><img src="../appp/../appp/images/partner/2.png" alt="Partner Image"></a>
                    </div>
                    <div class="partner-item">
                        <a href="#"><img src="../appp/../appp/images/partner/3.png" alt="Partner Image"></a>
                    </div>
                    <div class="partner-item">
                        <a href="#"><img src="../appp/../appp/images/partner/4.png" alt="Partner Image"></a>
                    </div>
                    <div class="partner-item">
                        <a href="#"><img src="../appp/../appp/images/partner/5.png" alt="Partner Image"></a>
                    </div>
                </div>
            </div>
        </div>
