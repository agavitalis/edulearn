	  ...
	  <div id="rs-slider" class="slider-section4 slider-overlay-2">
        <div id="home-slider">
            ...
            <div class="item active">
                <img src="{{ asset('appp/images/slider/home4/slide1.jpg') }}" alt="Slide1" />
                <div class="slide-content">
                    <div class="display-table">
                        <div class="display-table-cell">
                            <div class="container">
                                <h1 class="slider-title" data-animation-in="fadeInLeft"
                                    data-animation-out="animate-out">WELCOME<br>TO OUR UNIVERSITY</h1>
                                <p data-animation-in="fadeInUp" data-animation-out="animate-out" class="slider-desc">
                                    ...
                                    justo.<br> Nunc quis sapien in arcu pharetra volutpat.Morbi nec vulputate dolor.</p>
            ...
            <!-- Item 2 -->
            <div class="item">
                <img src="{{ asset('appp/images/slider/home4/slide2.jpg') }}" alt="Slide2" />
                <div class="slide-content">
                    <div class="display-table">
                        <div class="display-table-cell">
                            <div class="container">
            ...
            <!-- Item 3 -->
            <div class="item">
                <img src="{{ asset('appp/images/slider/home4/slide3.jpg') }}" alt="Slide3" />
                <div class="slide-content">
                    <div class="display-table">
                        <div class="display-table-cell">
                            <div class="container">
            ...
            <div class="row rs-vertical-bottom">
                <div class="col-lg-7 col-md-12">
                    ...
                    <p class="mobile-mb-50">
                        ...
                        and demoralized.can I get some?There are many variations of passages of Lorem Ipsum available,
                        but the majority have suffered alteration in some form, by injected yours humour, or randomised
                    ...
                    <div class="row about-signature">
                        ...
                        <div class="col-md-6 text-right">
                            <img src="{{ asset('appp/images/about/signature.png') }}" alt="signature">
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 col-md-12">
                    <div class="about-img rs-image-effect-shine">
                        <img src="{{ asset('appp/images/about/about2.jpg') }}" alt="img02">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row rs-vertical-middle">
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="rs-carousel owl-carousel rs-navigation-2" data-loop="true" data-items="2"
                        data-margin="30" data-autoplay="false" data-autoplay-timeout="5000" data-smart-speed="1200"
                        data-dots="true" data-nav="true" data-nav-speed="false" data-mobile-device="1"
                        data-mobile-device-nav="true" data-mobile-device-dots="true" data-ipad-device="2"
                        data-ipad-device-nav="true" data-ipad-device-dots="true" data-md-device="2"
                        data-md-device-nav="true" data-md-device-dots="true">
                        <div class="cource-item">
                            <div class="cource-img">
                                <img src="{{ asset('appp/images/courses/1.jpg') }}" alt="" />
                        ...
                        <div class="cource-item">
                            <div class="cource-img">
                                <img src="{{ asset('appp/images/courses/2.jpg') }}" alt="" />
                                <a class="image-link" href="courses-details.html" title="University Tour 2018">
                                    <i class="fa fa-link"></i>
                                </a>
                                <span class="course-value">$450</span>
                        ...
                        <div class="cource-item">
                            <div class="cource-img">
                                <img src="{{ asset('appp/images/courses/3.jpg') }}" alt="" />
                                <a class="image-link" href="courses-details.html" title="University Tour 2018">
                                    <i class="fa fa-link"></i>
                                </a>
                                <span class="course-value">$450</span>
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="rs-carousel owl-carousel rs-navigation-2" data-loop="true" data-items="2"
                        ...
                        <div class="event-item">
                            <div class="event-img">
                                <img src="{{ asset('appp/images/events/1.jpg') }}" alt="" />
                        ...
                        <div class="event-item">
                            <div class="event-img">
                                <img src="{{ asset('appp/images/events/2.jpg') }}" alt="" />
                                <a class="image-link" href="events-details.html" title="University Tour 2018">
                                    <i class="fa fa-link"></i>
                                </a>
                            </div>
                        ...
                        <div class="event-item">
                            <div class="event-img">
                                <img src="{{ asset('appp/images/events/3.jpg') }}" alt="" />
                                <a class="image-link" href="events-details.html" title="University Tour 2018">
                                    <i class="fa fa-link"></i>
                                </a>
                            </div>
            ...
            <div class="row rs-vertical-middle">
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="rs-carousel owl-carousel rs-navigation-2" data-loop="true" data-items="2"
                        ...
                        <div class="team-item">
                            <div class="team-img">
                                <img src="{{ asset('appp/images/team/1.jpg') }}" alt="team Image" />
                        ...
                        <div class="team-item">
                            <div class="team-img">
                                <img src="{{ asset('appp/images/team/2.jpg') }}" alt="team Image" />
                                <div class="normal-text">
                        ...
                        <div class="team-item">
                            <div class="team-img">
                                <img src="{{ asset('appp/images/team/3.jpg') }}" alt="team Image" />
                                <div class="normal-text">
                    ...
                    <div class="row">
                            ...
                            <div class="latest-news-slider">
                                <div>
                                    <div class="news-normal-block">
                                        <div class="news-img">
                                            <a href="#">
                                                <img src="{{ asset('appp/images/blog/1.jpg') }}" alt="" />
                                            </a>
                                        </div>
                                        <div class="news-date">
                                        ...
                                        <h4 class="news-title"><a href="blog-details.html">Those Other College Expenses
                                                You Aren't Thinking About</a></h4>
                                        <div class="news-desc">
                                            <p>
                                ...
                                <div>
                                    <div class="news-normal-block">
                                        <div class="news-img">
                                            <a href="#">
                                                <img src="{{ asset('appp/images/blog/5.jpg') }}" alt="" />
                                            </a>
                                        </div>
                                        <div class="news-date">
                                            <i class="fa fa-calendar-check-o"></i>
                                ...
                                <div>
                                    <div class="news-normal-block">
                                        <div class="news-img">
                                            <a href="#">
                                                <img src="{{ asset('appp/images/blog/6.jpg') }}" alt="" />
                                            </a>
                                        </div>
                                        <div class="news-date">
                                            <i class="fa fa-calendar-check-o"></i>
                        ...
                        <div class="col-md-3">
                            <div class="latest-news-nav">
                                <div><img src="{{ asset('appp/images/blog/t1.jpg') }}" alt="" /></div>
                                <div><img src="{{ asset('appp/images/blog/t2.jpg') }}" alt="" /></div>
                                <div><img src="{{ asset('appp/images/blog/t3.jpg') }}" alt="" /></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row rs-vertical-middle">
                <div class="col-lg-4 col-md-12">
                    ...
                    <p class="mobile-mb-50">On the other hand, we denounce with righteous indignation and dislike men
                ...
                <div class="col-lg-8  col-md-12">
                    <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30"
                        ...
                        data-ipad-device-dots="true" data-md-device="3" data-md-device-nav="false"
                        data-md-device-dots="true">
                        <div class="product-item">
                            <div class="product-img">
                                <a href="#">
                                    <img src="{{ asset('appp/images/products/1.jpg') }}" alt="" />
                                </a>
                            </div>
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                <a href="#">
                                    <img src="{{ asset('appp/images/products/2.jpg') }}" alt="" />
                                </a>
                            </div>
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                <a href="#">
                                    <img src="{{ asset('appp/images/products/3.jpg') }}" alt="" />
                                </a>
                            </div>
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                <a href="#">
                                    <img src="{{ asset('appp/images/products/4.jpg') }}" alt="" />
                                </a>
                            </div>
                ...
                <div class="col-lg-8  col-md-12">
                    <div class="rs-carousel owl-carousel" data-loop="true" data-items="2" data-margin="30"
                        ...
                        <div class="testimonial-item">
                            <div class="testi-img">
                                <img src="{{ asset('appp/images/testimonial/1.jpg') }}" alt="Jhon Smith">
                            </div>
                        ...
                        <div class="testimonial-item">
                            <div class="testi-img">
                                <img src="{{ asset('appp/images/testimonial/2.jpg') }}" alt="Jhon Smith">
                            </div>
                            <div class="testi-desc">
                        ...
                        <div class="testimonial-item">
                            <div class="testi-img">
                                <img src="{{ asset('appp/images/testimonial/3.jpg') }}" alt="Jhon Smith">
                            </div>
                            <div class="testi-desc">
                                <h4 class="testi-name">Aliana D’suza</h4>
                                <p>
                        ...
                        <div class="testimonial-item">
                            <div class="testi-img">
                                <img src="{{ asset('appp/images/testimonial/4.jpg') }}" alt="Jhon Smith">
                            </div>
                            <div class="testi-desc">
                                <h4 class="testi-name">Aliana D’suza</h4>
                                <p>
                        ...
                        <div class="testimonial-item">
                            <div class="testi-img">
                                <img src="{{ asset('appp/images/testimonial/5.jpg') }}" alt="Jhon Smith">
                            </div>
                            <div class="testi-desc">
                                <h4 class="testi-name">Aliana D’suza</h4>
                                <p>
        ...
        <div class="container">
            <div class="rs-carousel owl-carousel" data-loop="true" data-items="5" data-margin="80" data-autoplay="true"
                ...
                <div class="partner-item">
                    <a href="#"><img src="{{ asset('appp/images/partner/1.png') }}" alt="Partner Image"></a>
                </div>
                <div class="partner-item">
                    <a href="#"><img src="{{ asset('appp/images/partner/2.png') }}" alt="Partner Image"></a>
                </div>
                <div class="partner-item">
                    <a href="#"><img src="{{ asset('appp/images/partner/3.png') }}" alt="Partner Image"></a>
                </div>
                <div class="partner-item">
                    <a href="#"><img src="{{ asset('appp/images/partner/4.png') }}" alt="Partner Image"></a>
                </div>
                <div class="partner-item">
                    <a href="#"><img src="{{ asset('appp/images/partner/5.png') }}" alt="Partner Image"></a>
                </div>
            </div>
        </div>
    </div>
