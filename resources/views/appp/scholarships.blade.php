    ...
    <div class="blog-page-area sec-spacer">
        <div class="container">
            <div class="row mb-50 blog-inner">
                <div class="col-lg-6 col-md-12">
                    <div class="blog-images">
                        <a href="blog-details.html"><i class="fa fa-link" aria-hidden="true"></i> <img src="../appp/images/blogpage/1.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
            ...
            <div class="row mb-50 blog-inner">
                <div class="col-lg-6 col-md-12">
                    <div class="blog-images">
                        <a href="blog-details.html"><i class="fa fa-link" aria-hidden="true"></i> <img src="../appp/images/blogpage/2.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="blog-content">
            ...
            <div class="row mb-50 blog-inner">
                <div class="col-lg-6 col-md-12">
                    <div class="blog-images">
                        <a href="blog-details.html"><i class="fa fa-link" aria-hidden="true"></i> <img src="../appp/images/blogpage/3.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="blog-content">
            ...
            <div class="row mb-50 blog-inner">
                <div class="col-lg-6 col-md-12">
                    <div class="blog-images">
                        <a href="blog-details.html"><i class="fa fa-link" aria-hidden="true"></i> <img src="../appp/images/blogpage/4.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="blog-content">
            ...
            <div class="row mb-50 blog-inner">
                <div class="col-lg-6 col-md-12">
                    <div class="blog-images">
                        <a href="blog-details.html"><i class="fa fa-link" aria-hidden="true"></i> <img src="../appp/images/blogpage/5.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="blog-content">
