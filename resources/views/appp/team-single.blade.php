...
<!-- Mirrored from keenitsolutions.com/products/html/edulearn/edulearn-demo/teachers-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Dec 2020 23:57:10 GMT -->
<head>
        <!-- meta tag -->
        <meta charset="utf-8">
                                                ...
                                                <ul class="sub-menu"> 
                                                    <li class="current-menu-item menu-item-has-children"> <a href="#">Teachers</a>
                                                      <ul class="sub-menu">
                                                        ...
                                                        <li class="active"><a href="teachers-single.html">Teachers Single</a> </li>
                                                      </ul>
                                                    </li>
				...
				<div class="row team">
				    <div class="col-lg-4 col-md-12">
				        <div class="team-photo mobile-mb-40">
				            <img src="images/teachers/team-single.jpg" alt="Team1">
				    ...
				    <div class="col-lg-8 col-md-12">
				        <h3 class="team-name">Sarline D’Cruse</h3>
				        <p class="team-title">
				        	Assistant Professor (Accounting)
							<span>Business Studies</span>
				        </p>
				        <p class="team-contact">
				        	<i class="fa fa-mobile"></i> (+088) 2957 439 <i class="ml-15 fa fa-envelope-o"></i> sarlinemail@gmail.com
				        </p>
				        <p>
...
<!-- Mirrored from keenitsolutions.com/products/html/edulearn/edulearn-demo/teachers-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Dec 2020 23:57:12 GMT -->
</html>