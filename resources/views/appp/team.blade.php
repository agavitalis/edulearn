...
<!-- Mirrored from keenitsolutions.com/products/html/edulearn/edulearn-demo/teachers-without-filter.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Dec 2020 23:57:10 GMT -->
<head>
        <!-- meta tag -->
        <meta charset="utf-8">
                                                ...
                                                <ul class="sub-menu"> 
                                                    <li class="current-menu-item menu-item-has-children"> <a href="#">Teachers</a>
                                                      <ul class="sub-menu">
                                                        ...
                                                        <li class="active"><a href="teachers-without-filter.html">Teachers Without Filter</a> </li> 
