...
<head>
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-xl-7"><img class="bg-img-cover bg-center" src="https://admin.pixelstrap.com/cuba/assets/images/login/2.jpg" alt="looginpage"></div>
        <div class="col-xl-5 p-0">
          <div class="login-card">
            <div>
              <div><a class="logo text-left" href="index.html"><img class="img-fluid for-light" src="https://admin.pixelstrap.com/cuba/assets/images/logo/login.png" alt="looginpage"><img class="img-fluid for-dark" src="https://admin.pixelstrap.com/cuba/assets/images/logo/logo_dark.png" alt="looginpage"></a></div>
