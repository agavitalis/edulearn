...
<head>
    <!-- meta tag -->
    <meta charset="utf-8">
    <title>Edulearn | Scholarships</title>
                            ...
                            <div class="col-sm-12">
                                ...
                                <nav class="rs-menu">
                                    <ul class="nav-menu">
                                        ...
                                        <!--Scholarships Menu Start-->
                                        <li class="menu-item-has-children"> <a href="/scholarships">Scholarships</a>
                    
                                        </li>
                                        <!--Scholarships Menu End-->

                                        <!--Faq Menu Start-->
                                        <li class="menu-item-has-children"> <a href="/faq">Faqs</a>
