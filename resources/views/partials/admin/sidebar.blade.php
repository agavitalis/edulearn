        ...
        <div id="sidebar-menu">
            <ul class="sidebar-links custom-scrollbar">
                ...
                <li class="sidebar-list">
                    <a class="sidebar-link" href="dashboard"><i data-feather="home"></i><span>Dashboard </span></a>
                </li>
                <li class="sidebar-main-title">
                    <div>
                        <h6 class="lan-1">Scholarships</h6>
                        <p class="lan-2">Applications,Overview & Exams.</p>
                    </div>
                </li>
                <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i data-feather="gift"></i><span class="lan-3">Scholarships </span></a>
                ...
                <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i data-feather="git-pull-request"></i><span class="lan-3">Configuration </span></a>
                    <ul class="sidebar-submenu">
                ...
                <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="#"><i data-feather="file-text"></i><span class="lan-3">Examinations </span></a>
                    <ul class="sidebar-submenu">
                        <li><a class="lan-4" href="create-an-exam">Create an Examination</a></li>
