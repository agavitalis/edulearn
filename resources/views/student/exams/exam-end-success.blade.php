                ...
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <h2 class="title">Exam Successful Ended</h2>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p>Your Scholarship Exam for {{$exam->application->scholarship->name}} Scheme was successfully submited. You will contacted if you where selected for the next stage:</p>
                        ...
                        <tbody>
                            <tr>
                                <td style="font-size: 13px; font-weight: 400; color: #444444; letter-spacing: 0.2px;width: 100%;">
                                    ...
                                    <p style="text-align: left;font-weight: normal; font-size: 14px; color: #000000;line-height: 21px;    margin-top: 0;">Kindly update your profile with the correct details, as you they will be used as the primary source of contact should you be selected. <br> Good Luck! </p>
                                </td>
