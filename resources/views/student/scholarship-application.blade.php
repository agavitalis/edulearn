                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link pl-0" data-toggle="collapse"
                                            data-target="#collapseicon1" aria-expanded="true"
                                ...
                                <div class="collapse show" id="collapseicon2" data-parent="#accordion"
                                    ...
                                    <div class="card-body animate-chk">
                                        ...
                                        <label class="d-block" for="chk-ani13">
                                            <input class="checkbox_animated" id="chk-ani13" type="checkbox"> Front end
                                            designer(15)
                                        </label>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link pl-0" data-toggle="collapse"
                                            data-target="#collapseicon3" aria-expanded="true"
                                ...
                                <div class="collapse show" id="collapseicon3" data-parent="#accordion"
                                    ...
                                    <div class="card-body animate-chk">
                                        ...
                                        <label class="d-block mb-0" for="chk-ani20">
                                            <input class="checkbox_animated" id="chk-ani20" type="checkbox"> Financial
                                            Services(5)
                                        </label>
                                    </div>
                                    <button class="btn btn-block btn-primary text-center" type="button">All
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link pl-0" data-toggle="collapse"
                                            data-target="#collapseicon4" aria-expanded="true"
                                ...
                                <div class="collapse show" id="collapseicon4" data-parent="#accordion"
                                    ...
                                    <div class="card-body animate-chk">
                                        <label class="d-block" for="chk-ani21">
                                            <input class="checkbox_animated" id="chk-ani21" type="checkbox"> HTML,scss &
                                            sass
                                        </label>
                                ...
                                <div class="media-body">
                                    <h6 class="f-w-600"><a href="#">UI Designer</a><span class="pull-right">
                                            <button class="btn btn-primary" type="button"><span><i
                                                ...
                                                job</button></span></h6>
                                    <p>Endless Telecom & Technologies , NY<span><i
                            ...
                            <div class="job-description">
                                ...
                                <form class="form theme-form">
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Full Name:<span
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="exampleFormControlInput3">Email:<span
                                                        class="font-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="exampleFormControlpassword">Password:<span
                                                        class="font-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="exampleFormControlpassword1">Repeat Password:<span
                                                        class="font-danger">*</span></label>
                                ...
                                <form class="form theme-form">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="exampleFormControlInput5">College Name:<span
                                                        class="font-danger">*</span></label>
                                        ...
                                        <div class="col-xl-6 xl-100 xl-mt-job">
                                            <label class="col-form-label text-right pt-0">Period:<span
                                                    class="font-danger">*</span></label>
                                            <div class="row">
                                                <div class="col-sm-6">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="exampleFormControlInput6">Specialization:<span
                                                        class="font-danger">*</span></label>
                                ...
                                <form class="form theme-form">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="exampleFormControlInput7">Location:<span
                                                        class="font-danger">*</span></label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="exampleFormControlInput8">Company Name:<span
                                                        class="font-danger">*</span></label>
