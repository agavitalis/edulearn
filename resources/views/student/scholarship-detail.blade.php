...
<!-- Mirrored from admin.pixelstrap.com/cuba/theme/learning-detailed.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Dec 2020 12:44:32 GMT -->
<head>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
            ...
            <ul class="nav-menus">
              ...
              <li class="cart-nav onhover-dropdown">
                ...
                <ul class="cart-dropdown onhover-show-div">
                  ...
                  <li class="mt-0">
                    <div class="media"><img class="img-fluid rounded-circle mr-3 img-60" src="https://admin.pixelstrap.com/cuba/assets/images/ecommerce/01.jpg" alt="">
                  ...
                  <li class="mt-0">
                    <div class="media"><img class="img-fluid rounded-circle mr-3 img-60" src="https://admin.pixelstrap.com/cuba/assets/images/ecommerce/03.jpg" alt="">
                      <div class="media-body"><span>V-Neck Shawl Collar Woman's Solid T-Shirt</span>
                        <p>Yellow(#fcb102)</p>
                        <div class="qty-box">
                          <div class="input-group"><span class="input-group-prepend">
              ...
              <li class="onhover-dropdown"><i data-feather="message-square"></i>
                <ul class="chat-dropdown onhover-show-div">
                  ...
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle mr-3" src="https://admin.pixelstrap.com/cuba/assets/images/user/1.jpg" alt="">
                  ...
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle mr-3" src="https://admin.pixelstrap.com/cuba/assets/images/user/2.jpg" alt="">
                      <div class="status-circle online"></div>
                  ...
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle mr-3" src="https://admin.pixelstrap.com/cuba/assets/images/user/4.jpg" alt="">
      ...
      <div class="page-body-wrapper sidebar-icon">
        ...
        <div class="sidebar-wrapper">
          ...
          <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid" src="https://admin.pixelstrap.com/cuba/assets/images/logo/logo-icon.png" alt=""></a></div>
          <nav class="sidebar-main">
            <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
            <div id="sidebar-menu">
              <ul class="sidebar-links custom-scrollbar">
                <li class="back-btn"><a href="index.html"><img class="img-fluid" src="https://admin.pixelstrap.com/cuba/assets/images/logo/logo-icon.png" alt=""></a>
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="https://admin.pixelstrap.com/cuba/starter-kit/index.html" target="_blank"><i data-feather="anchor"></i><span>Starter kit</span></a></li>
                        ...
                        <div class="col mega-box">
                          <div class="link-section">
                            ...
                            <ul class="submenu-content opensubmegamenu">
                              ...
                              <li><a href="login-sa-validation-2.html" target="_blank">Login with sweetalert</a></li>
            ...
            <div class="row">
              <div class="col-xl-9 xl-60">
                <div class="blog-single">
                  <div class="blog-box blog-details"><img class="img-fluid w-100" src="https://admin.pixelstrap.com/cuba/assets/images/faq/learning-1.png" alt="blog-main">
                  ...
                  <section class="comment-box">
                    ...
                    <ul>
                      <li>
                        <div class="media align-self-center"><img class="align-self-center" src="https://admin.pixelstrap.com/cuba/assets/images/blog/comment.jpg" alt="Generic placeholder image">
                      ...
                      <li>
                        <ul>
                          <li>
                            <div class="media"><img class="align-self-center" src="https://admin.pixelstrap.com/cuba/assets/images/blog/9.jpg" alt="Generic placeholder image">
                              <div class="media-body">
                                <div class="row">
                                  <div class="col-xl-12">
                                    <h6 class="mt-0">Jolio Mark<span> ( Designer )</span></h6>
                      ...
                      <li>
                        <div class="media"><img class="align-self-center" src="https://admin.pixelstrap.com/cuba/assets/images/blog/4.jpg" alt="Generic placeholder image">
                          <div class="media-body">
                            <div class="row">
                              <div class="col-md-4 xl-100">
                                <h6 class="mt-0">Jolio Mark<span> ( Designer )</span></h6>
