...
<!-- Mirrored from admin.pixelstrap.com/cuba/theme/learning-list-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Dec 2020 12:44:32 GMT -->
<head>
              ...
              <div class="col-xl-9 xl-60">
                <div class="row">
                  ...
                  <div class="col-xl-4 xl-50 col-sm-6 box-col-6">
                    <div class="card">
                      <div class="blog-box blog-grid text-center product-box">
                        <div class="product-img"><img class="img-fluid top-radius-blog" src="https://admin.pixelstrap.com/cuba/assets/images/faq/3.jpg" alt="">
                  ...
                  <div class="col-xl-4 xl-50 col-sm-6 box-col-6">
                    <div class="card">
                      <div class="blog-box blog-grid text-center product-box">
                        <div class="product-img"><img class="img-fluid top-radius-blog" src="https://admin.pixelstrap.com/cuba/assets/images/faq/1.jpg" alt="">
                          <div class="product-hover">
                            <ul>
                              <li><i class="icon-link"></i></li>
                              <li><i class="icon-import"></i></li>
                  ...
                  <div class="col-xl-4 xl-50 col-sm-6 box-col-6">
                    <div class="card">
                      <div class="blog-box blog-grid text-center product-box">
                        <div class="product-img"><img class="img-fluid top-radius-blog" src="https://admin.pixelstrap.com/cuba/assets/images/faq/4.jpg" alt="">
                          <div class="product-hover">
                            <ul>
                              <li><i class="icon-link"></i></li>
                              <li><i class="icon-import"></i></li>
                  ...
                  <div class="col-xl-4 xl-50 col-sm-6 box-col-6">
                    <div class="card">
                      <div class="blog-box blog-grid text-center product-box">
                        <div class="product-img"><img class="img-fluid top-radius-blog" src="https://admin.pixelstrap.com/cuba/assets/images/faq/2.jpg" alt="">
                          <div class="product-hover">
                            <ul>
                              <li><i class="icon-link"></i></li>
                              <li><i class="icon-import"></i></li>
